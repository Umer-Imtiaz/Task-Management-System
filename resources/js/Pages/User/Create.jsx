          ...
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <form className="my-2 mx-1" onSubmit={onSubmit}>
                ...
                <TextInput name="name" id="user_name" className="w-full block my-2" onChange={(e)=>setData('name',e.target.value)}/>
                </div>
                <InputError message={errors.name} className="my-2 text-red"/>
                <div className="mt-2">
                <InputLabel htmlFor="email" value="user email"></InputLabel>
                <TextInput name="email" type="email" id="user_email" className="w-full block my-2" onChange={(e)=>setData('email',e.target.value)}/>
                </div>
                <InputError message={errors.email} className="my-2 text-red"/>

                <div className="mt-2">
                <InputLabel htmlFor="password" value="Password"></InputLabel>
                <TextInput name="password" type="password" id="user_name" className="w-full block my-2" onChange={(e)=>setData('password',e.target.value)}/>
                </div>
                <InputError message={errors.password} className="my-2 text-red"/>
                <div className="mt-2">
                <InputLabel htmlFor="confirm password" value="Confirm password"></InputLabel>
                <TextInput name="password_confirmation" type="password" id="user_name" className="w-full block my-2" onChange={(e)=>setData('password_confirmation',e.target.value)}/>
                </div>
