          ...
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <form className="my-2 mx-1" onSubmit={onSubmit}>
                ...
                <SelectInput name="project_id" className="w-full block my-2" id="project_id" onChange={(e)=>setData('project_id',e.target.value)}>   
                ...
                <TextInput name="name" id="task_name" className="w-full block my-2" onChange={(e)=>setData('name',e.target.value)}/>
                </div>
                <InputError message={errors.name} className="my-2 text-red"/>
                <div className="mt-2">
                <InputLabel htmlFor="description" value="Task Description"></InputLabel>
                <TextAreaInput name="description" id="task_description" className="w-full block my-2" onChange={(e)=>setData('description',e.target.value)}></TextAreaInput>
                </div>
                <InputError message={errors.description} className="my-2 text-red"/>
                <div className="mt-2">
                <InputLabel htmlFor="due_date" value="Task Deadline"></InputLabel>
                <TextInput type="date" name="due_date"  id="task_due_date" className="w-full block my-2" onChange={(e)=>setData('due_date',e.target.value)}/>
                </div>
                <InputError message={errors.due_date} className="my-2 text-red"/>
                <div className="mt-2">
                <InputLabel htmlFor="task_status" value="Task Status"></InputLabel>
                <SelectInput name="status" className="w-full block my-2" id="task_status" onChange={(e)=>setData('status',e.target.value)}>
                ...
                <SelectInput name="priority" className="w-full block my-2" id="priority" onChange={(e)=>setData('priority',e.target.value)}>
                ...
                <SelectInput name="assigned_user_id" className="w-full block my-2" id="assigned_user_id" onChange={(e)=>setData('assigned_user_id',e.target.value)}>   
