          ...
          <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg dark:bg-gray-800">
            <div className="p-6 text-gray-900 dark:text-gray-100">
              <form className="my-2 mx-1" onSubmit={onSubmit}>
                ...
                <div className="mt-2">
                {project.image_path &&  <div className="my-2">
                  <img className="w-64" src={project.image_path}/> 
                </div>  }
                ...
                <TextInput name="name" id="project_name" className="w-full block my-2" defaultValue={project.name} onChange={(e)=>setData('name',e.target.value)}/>
                </div>
                ...
                <TextAreaInput name="description" id="project_description" defaultValue={project.description} className="w-full block my-2" onChange={(e)=>setData('description',e.target.value)}></TextAreaInput>
                </div>
                ...
                <TextInput type="date" name="due_date"  id="project_due_date" defaultValue={project.due_date} className="w-full block my-2" onChange={(e)=>setData('due_date',e.target.value)}/>
                </div>
                ...
                <SelectInput name="status" className="w-full block my-2" id="project_status" defaultValue={project.status} onChange={(e)=>setData('status',e.target.value)}>
